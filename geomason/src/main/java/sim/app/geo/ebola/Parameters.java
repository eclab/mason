...
public class Parameters
{
    ...
    public static double WORLD_LENGTH = Parameters.WORLD_TO_POP_SCALE * Parameters.POP_BLOCK_METERS;//The size of one grid cell in meters
    ...
    public static double convertToKilometers(final double val)
    {
        return (val * (Parameters.POP_BLOCK_METERS/Parameters.WORLD_TO_POP_SCALE))/1000.0;
    }

    public static double convertFromKilometers(final double val)
    {
