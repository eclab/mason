...
public class DGeomGridField extends GeomField{
    ...
    public GridDataType getGridDataType()
    {
        ...
        if (getGrid() instanceof DIntGrid2D)
        {
            return GridDataType.INTEGER;
        }
        else if (getGrid() instanceof DDoubleGrid2D)
        {
            return GridDataType.DOUBLE;
        }
        
        /*
        if (getGrid() instanceof DDoubleGrid2D)
        {
            return GridDataType.DOUBLE;
        }
        */
     ...
     * 
     */
    //private DDoubleGrid2D grid = null;
    private DAbstractGrid2D grid;

    
    public DGeomGridField()
    {
        super();
    }


    public DGeomGridField(DDoubleGrid2D wrappedGrid)
    {
        super();
    ...
    /*
    public final DDoubleGrid2D getGrid()
    {
        return grid;
    }
    */

    public final DAbstractGrid2D getGrid()
    {
        return grid;
    }    
    
    /*
    public final void setGrid(DDoubleGrid2D newGrid)
    {
        grid = newGrid;
    ...
    */
    ...
    public final void setGrid(DAbstractGrid2D newGrid)
    {
        grid = newGrid;
