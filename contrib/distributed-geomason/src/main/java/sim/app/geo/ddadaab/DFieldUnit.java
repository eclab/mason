...
public class DFieldUnit extends DObject implements Valuable, java.io.Serializable{
    ...
    public boolean isCampOccupied(DDadaab dadaab) {
    ...
    public void addRefugeeHH(DFamily r) {

        this.refugeeHH.add(r);
    }

    public void removeRefugeeHH(DFamily r) {
    ...
    public void addRefugee(DRefugee r) {

        this.refugee.add(r);
    }

    public void removeRefugee(DRefugee r) {
    ...
    public void setFacility(DFacility f){
        this.facility =f;
    }
    
    public DFacility getFacility(){
        return facility;
    }
   ...
   public boolean equals(DFieldUnit b) {
  ...
  // calaculate distance 
    public double distanceTo(DFieldUnit b) {
    ...
    DFieldUnit copy() {
        DFieldUnit l = new DFieldUnit(this.getX(), this.getY());
        return l;
    }
