...
public class DFacility extends DSteppable implements Valuable{

    
    //private int capacity  = 0; // if we need to limit the capacity of each facility
    private int facilityID; // id
    DFieldUnit location; // location of the facility
...
//    }
    ...
    public void setLoc(DFieldUnit loc){
        this.location =  loc;
    }
    
    public DFieldUnit getLoc(){
        return location;
    }
    ...
    public boolean isReachedCapacity(DFieldUnit f,DDadaab d){
    ...
    public void refillBorehole( DDadaab d){
    // only those borehole fields
        
        for(Object obj: d.boreHoles){
            DFieldUnit f = (DFieldUnit)obj;
    ...
    public void resetPatientNumber(DDadaab d){
