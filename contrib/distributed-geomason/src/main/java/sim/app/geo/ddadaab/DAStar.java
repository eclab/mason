...
public class DAStar {
    ...
    static public ArrayList<DFieldUnit> astarPath(DDadaab world, Node start, Node goal) {
...
//      
   ...
   */
  static ArrayList<DFieldUnit> reconstructPath(AStarNodeWrapper n) {
      ArrayList<DFieldUnit> result = new ArrayList<DFieldUnit>();
