...
public class DGrower extends DSteppable{
    ...
    {
        DSleuthWorld world = (DSleuthWorld) state;
        ...
        ArrayList<DTile> spontaneouslyUrbanized = world.spontaneousGrowth(dispersion_value);
        ...
        ArrayList<DTile> spreadFromUrbanized = world.newSpreadingCenters(spontaneouslyUrbanized);
        ...
        ArrayList<DTile> growthAroundCenters = world.edgeGrowth();

        // compile a list of all cells urbanized this turn; preallocate the array
        // to accommodate the stuff we're about to add to it.
        ArrayList<DTile> allGrowthThisTurn = new ArrayList<DTile>(spontaneouslyUrbanized.size() + spreadFromUrbanized.size() + growthAroundCenters.size());
