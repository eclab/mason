...
\vspace{-3em}\includegraphics[width=2.5in]{LeadProbe.pdf}
\vspace{-1em}
...
\vspace{-1em}
\caption{A Multi has some number of Receivers (which you provide) that are connected to a subgraph, and eventually output to some number of Providers (which you also provide).  The Receivers and Providers are connected to the outer world. }
\vspace{-1em}
\end{wrapfigure}
