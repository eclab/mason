...
public class PyramidTestWithUI extends GUIState
    {
    ...
    public static void main(String[] args)
        {
        new PyramidTestWithUI().createController();  // randomizes by currentTimeMillis
        }
    ...
    public PyramidTestWithUI()
        {
        super(new PyramidTest(System.currentTimeMillis()));
        }
    
    public PyramidTestWithUI(SimState state) 
        {
        super(state);
        }

    public static String getName() { return "PyramidTest Example"; }
    ...
    public void setupPortrayals()
        {
        PyramidTest jbox2d = (PyramidTest)state;
        ...
        boxesPortrayal.setPortrayalForAll(new AdjustablePortrayal2D(
        	new sim.portrayal.simple.MovablePortrayal2D(        			
        		new JBox2DPortrayal(new Rectangle2D.Double(-40, -40, 80, 80)))));
