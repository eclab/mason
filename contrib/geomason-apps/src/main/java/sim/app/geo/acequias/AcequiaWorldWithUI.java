...
public class AcequiaWorldWithUI extends GUIState {
	...
	SparseGridPortrayal2D acequias = new SparseGridPortrayal2D();
	SparseGridPortrayal2D acequiaTracts = new SparseGridPortrayal2D();
	SparseGridPortrayal2D counties = new SparseGridPortrayal2D();
	SparseGridPortrayal2D elevation = new SparseGridPortrayal2D();
	SparseGridPortrayal2D hydrologicalFeatures = new SparseGridPortrayal2D();
	SparseGridPortrayal2D landUse = new SparseGridPortrayal2D();
	SparseGridPortrayal2D roads = new SparseGridPortrayal2D();
		NetworkPortrayal2D waterNetwork = new NetworkPortrayal2D();	
	SparseGridPortrayal2D hydrationPortrayal = new SparseGridPortrayal2D();
	...
	public void start() {
		...
		waterNetwork.setField( new SpatialNetwork2D(aw.tiles, aw.waterflow));
	...
	public void init(Controller c) {
		...
		display.attach( hydrationPortrayal, "Hydration", true);
		display.attach( waterNetwork, "Functioning Water Network", true);
