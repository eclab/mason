                ...
                for(T obj : objs)
                    ...
                    if (obj instanceof Stopping)
                        ...
                        if (stop == null)
                            ...
                            {
                            throw new RuntimeException("Cannot remove agent " + stop + " from " + p + " because it is wrapped in a Stoppable other than a DIterativeRepeat or DistributedTenativeStep.  This should not happen.");
                            }
                        }
                    }
                }
