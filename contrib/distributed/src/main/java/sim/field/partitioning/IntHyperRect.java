...
/**
 * Class that defines a Hyper Rectangle and contains many helper methods to work
...
public class IntHyperRect implements Comparable<IntHyperRect>, Iterable<IntPoint> {
	...
	/**
	 * @return area of the hyper rectangle
	 */
	public int getArea() {
	...
	/**
	 * @return size of the hyper rectangle in each dimension
	 */
	public int[] getSize() {
	 ...
	 * @param p
	 * 
	 * @return true if the rectangle contains p. Noted that the rectangle is treated
	 *         as half-inclusive (ul) and half-exclusive (br)
	 */
	 ...
	 * @param that
	 * 
	 * @return true if the given rect is inside this rectangle
	 */
	 ...
	 * @param that
	 * 
	 * @return true if the given rect intersects with this rectangle
	 */
	...
	/**
	 * @param that
	 * @return the intersection of the given rect and this rect
	 */
	...
	/**
	 * Symmetric resize in all dimensions
	 * 
	 * @param vals
	 * @return resized rectangle
	 */
	...
	/**
	 * One-sided resize in all dimensions
	 * 
	 * @param dir
	 * @param vals
	 * @return resized rectangle
	...
	/**
	 * Move the rect by the given offsets in the opposite direction.
	 * 
	 * @param offsets
	 * 
	 * @return moved rectangle
	...
	/**
	 * @return upper left and bottom right points
	 */
	...
	/**
	 * @return all the vertices in order
	 */
	 ...
	 * @param that
	 * @param dim
	 * @return true if two hyper rectangles align along the given dimension
	 */
	...
	/**
	 * @param that
	 * @return true if two hyper rectangles equal (the two vertexs equal)
	 */
