...
public class DSimState extends SimState 
    ...
    protected DSimState(final long seed, final MersenneTwisterFast random, final DistributedSchedule schedule, final int width, final int height, final int aoiSize) 
        {
    ...
    protected DSimState(final long seed, final MersenneTwisterFast random, final DistributedSchedule schedule, final DPartition partition) 
        {
        super(seed, random, schedule);
        aoi = partition.aoi;
