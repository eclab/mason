...
Note that the noder returns a list of \class{NodedSegmentString}s, which may
be inconvenient. 
...
Geometry intPoints = (new BoundaryOp(brokenUpLines, BoundaryNodeRule.MULTIVALENT_ENDPOINT_BOUNDARY_RULE)).getBoundary();
