...
rectangles for all the layers.\index{minimum bounding rectangle}
\begin{Verbatim}[frame=lines,framesep=5mm,numbers=left,commandchars=+\[\]]
...
change your mind and want to see the \class{GeoVectorField}s.
...
Thank the MURI project for their support via NSF grant #.  For Andrew Crooks for
