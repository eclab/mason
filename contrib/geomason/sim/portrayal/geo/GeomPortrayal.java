...
public class GeomPortrayal extends SimplePortrayal2D {
    ...
    public GeomPortrayal() { this(null, 1.0, true); }
    public GeomPortrayal(Paint paint) { this(paint, 1.0, true); }
	public GeomPortrayal(double scale) { this(null, scale, true); }
    ...
    public GeomPortrayal(double scale, boolean filled) { this(null, scale, filled); }
    public GeomPortrayal(boolean filled) { this(null, 1.0, filled); }
