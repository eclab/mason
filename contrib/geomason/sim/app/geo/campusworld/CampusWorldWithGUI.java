 ...
 * CampusWorldWithGUI
 *
 * $Id: CampusWorldWithGUI.java,v 1.1 2010-04-13 21:00:22 mcoletti Exp $
 */
 ...
 * @author mcoletti
 */
public class CampusWorldWithGUI extends GUIState {
    ...
    public CampusWorldWithGUI(SimState state)
    {
        super(state);
    }

    public CampusWorldWithGUI() throws ParseException
    {
    ...
    {
        CampusWorldWithGUI worldGUI = null;

        //  Keith, what is this for?
// 		if (args.length > 0 && args[0].equals("-testing"))
// 			CampusWorldWithGUI.testing = true;

        try
        {
            worldGUI = new CampusWorldWithGUI();
        }
        catch (ParseException ex)
        {
            Logger.getLogger(CampusWorldWithGUI.class.getName()).log(Level.SEVERE, null, ex);
        }
