...
/**
 * Loads a Lightwave 3D scene file (.lws extension) or a Wavefront object file (.obj extension) into a BranchGroup, 
...
public class BranchGroupPortrayal3D extends PrimitivePortrayal3D
	...
	public static BranchGroup getBranchGroupForURL(URL url) throws IllegalArgumentException, FileNotFoundException
		...
		if (s.equalsIgnoreCase(".lws")) return new Lw3dLoader().load(url).getSceneGroup();
...
/*
	public static BranchGroup getBranchGroupForResource(String name) throws IllegalArgumentException, FileNotFoundException
		{
		return getBranchGroupForURL(BranchGroupPortrayal3D.class.getResource(name));
		}
*/
