...
\begin{itemize}
\item Display a seagull provided by the {\bf crowd3d} MASON demo.  Note that the seagull comes with its own coloring and will ignore attempts to change it with an Appearance (Compressed Geometry is like that, unfortunately):

\java{%
import javax.media.j3d*;\\
\\
\hbox{ShapePortrayal3D portrayal = new ShapePortrayal3D(new Shape3D(new sim.app.crowd3d.GullCG()));}
}
...
\\
ShapePortrayal3D portrayal = new ShapePortrayal3D(new ColorCube());
}
...
import javax.media.j3d.*;\\
\\
\hbox{Font3D font = new Font3D(new FontExtrusion(), new Font("SansSerif", Font.PLAIN, 60));}\\
\hbox{ShapePortrayal3D portrayal = new ShapePortrayal3D(new Shape3D(new Text3D(font, "Hello, World!")));}
}
\end{itemize}
