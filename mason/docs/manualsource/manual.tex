...
Java3D has a pretty limited collection of possible scene or object file types (\file{.lwo, .lws, .obj}).  However, the MASON website has a link to download {\bf NCSA Portfolio}, a free but not quite open source collection of loaders for a much wider range of files.\footnote{NCSA Portfolio is not free for commercial use.  Furthermore, if you create a derivative work using NCSA Portfolio, you must notify NCSA of this fact and also add a disclaimer to this effect in your distributed package.}  To use NCSA Portfolio with a BranchGroupPortrayal, you'd do something like this:
