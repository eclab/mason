...
Format:           java MyModel \textbackslash
                       [-help] [-repeat R] [-seed S] [-until U] [-quiet] \textbackslash
...
Piece of cake.  (Note that \variable{myObject} must be declared final.)
