...
\item \class{sim.portrayal3d.simple.Shape3DPortrayal3D} portrays objects with a loaded Shape3D.
\item \class{sim.portrayal3d.simple.ImagePortrayal3D} portrays objects with a flat image.
\item \class{sim.portrayal3d.simple.BranchGroupPortrayal3D} portrays objects using a provided BranchGroup.
\item \class{sim.portrayal3d.simple.SharedGroupPortrayal3D} portrays objects using a provided SharedGroup
...
\sidebar{How do I orient a cylinder or cone?}{See TransformedPortrayal3D.}
\paragraph{Spheres, Cylinders, and Cones}

The classes \Class{sim.portrayal3d.simple.SpherePortrayal3D}, \Class{sim.portrayal3d.simple.CylinderPortrayal3D},  and \Class{sim.portrayal3d.simple.ConePortrayal3D} are all subclasses of PrimitivePortrayal3D and all share more or less the same constructors.  Here are the constructors for CylinderPortrayal3D:
