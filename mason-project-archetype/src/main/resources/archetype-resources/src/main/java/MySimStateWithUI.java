...
public class MySimStateWithUI extends GUIState
    {
    ...
    public static void main(String[] args)
        {
        new MySimStateWithUI().createController();  // randomizes by currentTimeMillis
        }
...
// uncomment this to try out trails  (also need to uncomment out some others in this file, look around)
    ...
    public MySimStateWithUI()
        {
        super(new MySimState(System.currentTimeMillis()));
        }
    
    public MySimStateWithUI(SimState state) 
        {
        super(state);
        }
    ...
    public void setupPortrayals()
        {
        MySimState flock = (MySimState)state;
